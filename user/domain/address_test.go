...
var (
	...
	invalidAddress1 = Address{
		Street:     Street(strings.Repeat("a", minStreetLength-1)),
		District:   District(strings.Repeat("a", minDistrictLength-1)),
		City:       City(strings.Repeat("a", maxCityLength+1)),
		State:      State((strings.Repeat("a", maxStateLength+1))),
		Complement: Complement((strings.Repeat("a", maxComplementLength+1))),
		Number:     Number((strings.Repeat("1", maxNumberLength+1))),
		Zipcode:    Zipcode((strings.Repeat("1", zipcodeLength+1))),
		Latitude:   Latitude((strings.Repeat("1", 5))),
		Longitude:  Longitude((strings.Repeat("1", 5))),
	}
