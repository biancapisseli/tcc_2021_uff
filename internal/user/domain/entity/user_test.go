...
var (
	validUser = User{
		Name:  uservo.UserName((strings.Repeat("a", maxUserNameLength-1))),
		Email: uservo.Email((strings.Repeat("a", maxEmailLength-len(EMAIL_HOSTMAME)) + EMAIL_HOSTMAME)),
	}
	invalidUser1 = User{
		Name:  uservo.UserName((strings.Repeat("a", maxUserNameLength+1))),
		Email: uservo.Email((strings.Repeat("a", maxEmailLength))),
	}
	invalidUser2 = User{
		Name:  uservo.UserName((strings.Repeat("a", maxUserNameLength))),
		Email: uservo.Email((strings.Repeat("a", maxEmailLength+1))),
	}
