...
func (_m *Transaction) Exec(query string, args ...interface{}) (sqlxtx.SQLResult, error) {
	var _ca []interface{}
...
func (_m *Transaction) NamedExec(query string, arg interface{}) (sqlxtx.SQLResult, error) {
