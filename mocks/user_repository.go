...
func (_m *UserRepository) AddUser(ctx context.Context, user userent.User, password uservo.PasswordEncoded) (uservo.UserID, error) {
...
func (_m *UserRepository) AddUserAddress(ctx context.Context, userID uservo.UserID, address userent.Address) (uservo.AddressID, error) {
...
func (_m *UserRepository) GetUserAddress(ctx context.Context, userID uservo.UserID, addressID uservo.AddressID) (userent.RegisteredAddress, error) {
...
func (_m *UserRepository) GetUserAddresses(ctx context.Context, userID uservo.UserID) ([]userent.RegisteredAddress, error) {
...
func (_m *UserRepository) GetUserByEmailAndPassword(ctx context.Context, email uservo.Email, password uservo.PasswordEncoded) (userent.RegisteredUser, error) {
...
func (_m *UserRepository) GetUserInfo(ctx context.Context, userID uservo.UserID) (userent.RegisteredUser, error) {
	ret := _m.Called(ctx, userID)
...
func (_m *UserRepository) RemoveUser(ctx context.Context, userID uservo.UserID) error {
	ret := _m.Called(ctx, userID)
...
func (_m *UserRepository) RemoveUserAddress(ctx context.Context, userID uservo.UserID, addressID uservo.AddressID) error {
	ret := _m.Called(ctx, userID, addressID)
...
func (_m *UserRepository) SaveUserAddress(ctx context.Context, userID uservo.UserID, address userent.RegisteredAddress) error {
	ret := _m.Called(ctx, userID, address)
...
func (_m *UserRepository) UpdatePassword(ctx context.Context, userID uservo.UserID, newPassword uservo.PasswordEncoded) error {
